...
mod test {
    ...
    fn it_tests_bool_array() {
        assert_eq!(true, super::bool_array::is_palindrome_permutation("".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("a".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("aa".to_string()));

        assert_eq!(true, super::bool_array::is_palindrome_permutation("aab".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("aba".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("baa".to_string()));

        assert_eq!(true, super::bool_array::is_palindrome_permutation("baab".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("baba".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("bbaa".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("abab".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("abba".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("aabb".to_string()));

        assert_eq!(true, super::bool_array::is_palindrome_permutation("cbaab".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("cbaba".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("cbbaa".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("cabab".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("cabba".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("caabb".to_string()));

        assert_eq!(true, super::bool_array::is_palindrome_permutation("bcaab".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("bcaba".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("bcbaa".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("acbab".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("acbba".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("acabb".to_string()));

        assert_eq!(true, super::bool_array::is_palindrome_permutation("bacab".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("bacba".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("bbcaa".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("abcab".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("abcba".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("aacbb".to_string()));

        assert_eq!(true, super::bool_array::is_palindrome_permutation("baacb".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("babca".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("bbaca".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("abacb".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("abbca".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("aabcb".to_string()));

        assert_eq!(true, super::bool_array::is_palindrome_permutation("baabc".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("babac".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("bbaac".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("ababc".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("abbac".to_string()));
        assert_eq!(true, super::bool_array::is_palindrome_permutation("aabbc".to_string()));

        assert_eq!(false, super::bool_array::is_palindrome_permutation("ab".to_string()));
        assert_eq!(false, super::bool_array::is_palindrome_permutation("ab".to_string()));
        assert_eq!(false, super::bool_array::is_palindrome_permutation("abc".to_string()));
        assert_eq!(false, super::bool_array::is_palindrome_permutation("abcd".to_string()));
        assert_eq!(false, super::bool_array::is_palindrome_permutation("aabbcdde".to_string()));
    }
}
